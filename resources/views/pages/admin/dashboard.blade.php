...
@section('title')
    ADMIN | PERPUSTAKAAN UNIVERSITAS DINAMIKA SURABAYA
@endsection
              ...
              <div class="dashboard-content">
                <div class="row">
                  <div class="col-md-4">
                    <div class="card mb-2">
                      <div class="card-body">
                        <div class="dashboard-card-title">Peminjaman</div>
                  ...
                  <div class="col-md-4">
                    <div class="card mb-2">
                      <div class="card-body">
                        ...
                        <div class="dashboard-card-subtitle">{{ $totalgenre }}</div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="card mb-2">
                      <div class="card-body">
                        ...
                        <div class="dashboard-card-subtitle">{{ $totalbuku }}</div>
                      </div>
                    </div>
                  </div>
                </div>
